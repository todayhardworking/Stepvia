...
export const Navigation: React.FC<NavigationProps> = ({ currentView, setCurrentView, hasGoals, preferences }) => {
  ...
  const isLoggedIn = currentView !== 'landing' && currentView !== 'about';
  // Allow about page to be seen as logged in if we have goals, but for nav purposes 'about' is a specific view.
  // Actually, 'about' can be viewed by both. Let's rely on 'hasGoals' or just render different menus based on where we came from? 
  // Simple check: if we are in 'landing' or 'about' without goals, show logged out menu.
  
  const showLoggedInMenu = hasGoals && currentView !== 'landing'; 
        ...
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div 
              ...
              onClick={() => setCurrentView(hasGoals ? 'dashboard' : 'landing')}
            >
                ...
                <div className="space-y-1">
                   ...
                   <div className="mb-6 px-4 py-4 bg-gradient-to-br from-slate-800 to-slate-900 dark:from-slate-700 dark:to-slate-800 rounded-2xl text-white shadow-lg mx-1 relative overflow-hidden">
                      ...
                      <div className="flex items-center gap-3 mb-3 relative z-10">
                          ...
                          <div>
                             <p className="text-sm font-bold truncate max-w-[150px]">{preferences.displayName || 'Friend'}</p>
